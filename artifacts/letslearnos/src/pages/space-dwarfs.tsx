...
import { DWARF_PLANETS, getCelestialBody, type CelestialBody } from "@/content/space";
...
export default function SpaceDwarfsPage() {
  ...
  // Warm every dwarf planet's narration line as soon as the page mounts —
  // see the matching effect in space.tsx for why this matters.
  useEffect(() => {
    void prefetch(
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-4 top-4 z-30 flex h-20 w-20 items-center justify-center rounded-3xl bg-white/95 shadow-lg">
        <img
          src={ARTWORK(197)}
          alt="Umbreon, your Dwarf Planets guide"
